...
#ifndef UNTITLED1_BINANCE_LOGGER_H
#define UNTITLED1_BINANCE_LOGGER_H
...
public:
    static void write_log(basic_string<char, char_traits<char>, allocator<char>> fmt, ... );
...
#endif //UNTITLED1_BINANCE_LOGGER_H
